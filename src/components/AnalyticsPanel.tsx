...
export function AnalyticsPanel() {
  ...
  return (
    <div className="h-full overflow-y-auto px-3 py-2">
      <div className="text-[14px] font-bold text-fw-text mb-2">Performance Analytics</div>
      ...
      {analytics.totalTrades === 0 ? (
        ...
        <div className="space-y-3">
          {/* Period P&L Section */}
          <div>
            <div className="text-[14px] text-fw-text-secondary uppercase font-semibold mb-1.5">P&L Summary</div>
          ...
          {/* Key Metrics */}
          <div>
            <div className="text-[14px] text-fw-text-secondary uppercase font-semibold mb-1.5">Key Metrics</div>
            <div className="grid grid-cols-4 gap-2">
          ...
          {/* Trade Stats */}
          <div>
            <div className="text-[14px] text-fw-text-secondary uppercase font-semibold mb-1.5">Trade Statistics</div>
            <div className="grid grid-cols-4 gap-2">
