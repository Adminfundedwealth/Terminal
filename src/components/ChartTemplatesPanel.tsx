    ...
    <div className="h-full flex flex-col bg-[#0c0e14]">
      ...
      <div className="px-3 py-2 border-b border-fw-border flex items-center gap-2 flex-shrink-0">
        <input
          ...
          className="flex-1 bg-fw-bg border border-fw-border rounded text-[13px] px-2 py-1.5 text-fw-text outline-none focus:border-fw-accent"
        />
        <button onClick={handleSave} className="flex items-center gap-1 px-2 py-1.5 text-[14px] bg-fw-accent text-white rounded font-bold hover:brightness-110">
          <Save size={10} /> Save Current
        </button>
      </div>

      {/* Current state */}
      <div className="px-3 py-1.5 border-b border-fw-border/30 flex items-center gap-3 text-[14px] text-fw-text-muted flex-shrink-0">
      ...
      {toast && <div className="px-3 py-1.5 border-t border-fw-border text-[13px] text-fw-accent bg-fw-accent/5">{toast}</div>}
    </div>
  );
}
