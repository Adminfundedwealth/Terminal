...
export function HomeWorkspace() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#0b0d12] text-fw-text">
      <div className="px-3 py-2 border-b border-fw-border bg-[#0f1218]">
      ...
      <div className="flex-1 overflow-auto p-3">
        <div className="space-y-3">
          <section className="rounded-lg border border-fw-border bg-[#111621] p-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
              {[
                ...
                <div key={item.label} className="rounded-md border border-fw-border bg-[#0d1117] p-2">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-3">
            <section className="rounded-lg border border-fw-border bg-[#111621] p-3 min-h-[180px]">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={name} className="flex items-center justify-between rounded-md border border-fw-border bg-[#0d1117] px-2 py-1.5">
            ...
            <section className="rounded-lg border border-fw-border bg-[#111621] p-3 min-h-[180px]">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={item.label} className="rounded-md border border-fw-border bg-[#0d1117] px-2 py-1.5">
